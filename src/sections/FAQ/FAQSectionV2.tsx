...
/**
 * FAQ variant 2: Two-column layout on large screens. Use section ID "faq-v2" in homeSections.
 */
export function FAQSectionV2({ t }: HomeSectionContext) {
